        ...
        db.db(process.env.MONGODB_NAME || process.env.MONGODB_URI.split('/')[3]).collection('users').updateOne({
            ...
            if (!id2) {
                return db.close(null, function () {
                    ...
                    (0, _NuiAPI.sendText)(id1, process.env.USER_CANCEL || _lang.USER_CANCEL);
                });
            }
            db.db(process.env.MONGODB_NAME || process.env.MONGODB_URI.split('/')[3]).collection('users').updateOne({
                _id: id2
                ...
                return db.close(null, function () {
                    ...
                    (0, _NuiAPI.sendText)(id1, process.env.USER1_PP || _lang.USER1_PP);
                    (0, _NuiAPI.sendText)(id2, process.env.USER2_PP || _lang.USER2_PP);
                });
            });
        });
    });
