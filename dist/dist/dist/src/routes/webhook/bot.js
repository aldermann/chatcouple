...
var processPostback = exports.processPostback = function () {
    ...
    /*#__PURE__*/_regenerator2.default.mark(function _callee(senderId, payload, timestamp) {
                ...
                switch (_context.prev = _context.next) {
                    ...
                    case 3:
                        return _context.abrupt('return', (0, _newUser2.default)(senderId, timestamp).then(function () {
                            (0, _NuiAPI.sendText)(senderId, process.env.WELCOME_TEXT || _lang.WELCOME_TEXT);
                        }));

                    case 4:
                        return _context.abrupt('return', (0, _NuiAPI.sendText)(senderId, process.env.INSTRODUCTION || _lang.INSTRODUCTION));
...
var handleText = exports.handleText = function () {
    ...
    /*#__PURE__*/_regenerator2.default.mark(function _callee2(senderId, message, timestamp) {
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 8:
                        ...
                        return _context2.abrupt('return', (0, _NuiAPI.sendText)(senderId, process.env.REQUEST_MSG || _lang.REQUEST_MSG));
...
function processText(senderId, status, message) {
    ...
    switch (message.toLowerCase()) {
        ...
        default:
            if (status === 1) return (0, _NuiAPI.sendText)(senderId, process.env.REQUESTED_MSG || _lang.REQUESTED_MSG);
