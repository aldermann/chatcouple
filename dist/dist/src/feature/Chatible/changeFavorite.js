    ...
    MongoClient.connect(process.env.MONGODB_URI, {
        ...
        db.db(process.env.MONGODB_NAME || process.env.MONGODB_URI.split("/")[3]).collection("users").updateOne({
            ...
            db.close(null, function () {
                return (0, _NuiAPI.sendTemplatedMessage)(senderId, process.env.GENDER_CHANGE_SUCESS_TITLE || _lang.GENDER_CHANGE_SUCCESS_TITLE, process.env.GENDER_CHANGE_SUCCESS || _lang.GENDER_CHANGE_SUCCESS);
            });
        });
    });
};